package be.fooda.frontend.store.views;
...
import be.fooda.frontend.store.views.product.ProductView;
import be.fooda.frontend.store.views.store.StoreView;
import be.fooda.frontend.store.views.address.AddressView;
import be.fooda.frontend.store.views.order.OrderView;
import be.fooda.frontend.store.views.payment.PaymentView;
import be.fooda.frontend.store.views.delivery.DeliveryView;
import be.fooda.frontend.store.views.contact.ContactView;
import be.fooda.frontend.store.views.courier.CourierView;
import be.fooda.frontend.store.views.login.LoginView;
import com.vaadin.flow.component.avatar.Avatar;
import be.fooda.frontend.store.data.entity.User;
import be.fooda.frontend.store.security.AuthenticatedUser;
