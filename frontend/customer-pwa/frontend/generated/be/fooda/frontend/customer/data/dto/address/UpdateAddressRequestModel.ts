...
import UpdateCoordinateRequestModel from './UpdateCoordinateRequestModel';
 ...
 */
export default class UpdateAddressRequestModel<T extends UpdateAddressRequest = UpdateAddressRequest> extends ObjectModel<T> { 
  static createEmptyValue: () => UpdateAddressRequest;

  get city(): StringModel {
    return this[_getPropertyModel]('city', StringModel, [true]);
  }

  get coordinate(): UpdateCoordinateRequestModel {
    return this[_getPropertyModel]('coordinate', UpdateCoordinateRequestModel, [true]);
  }
