...
public class HttpEndpoints {
    ...
    public static final String PRODUCTS_POST_MANY_TEXT = "create/many/";
    ...
    public static final String PRODUCTS_DELETE_BY_ID_MAKE_PASSIVE = "delete/one/passive/{productId}";
