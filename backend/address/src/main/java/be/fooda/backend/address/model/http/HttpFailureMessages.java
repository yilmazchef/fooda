...
public enum HttpFailureMessages {
    ...
    FAILED_TO_MAKE_ADDRESS_PASSIVE("Failed to make address passive"),
    ...
    COORDINATE_IS_REQUIRED("Coordinate is required"),
    DOOR_IS_REQUIRED("Door is required"),
    POST_CODE_IS_REQUIRED("Post Code is required"),
    ADDRESS_COULD_NOT_BE_DELETED("Could not delete the address"),
